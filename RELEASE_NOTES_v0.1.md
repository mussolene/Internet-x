...
This release supports the claim that Internet-X is a credible identity-first overlay design point with explicit flow establishment and authenticated locator update under stated assumptions. It does not support claims of deployment readiness, full novelty, or real post-quantum security.
